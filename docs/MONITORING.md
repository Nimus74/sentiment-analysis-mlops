...
> Questo monitoring è dimostrativo: non è una pipeline production-ready completa (scheduler/alerting/labeling automatico), ma serve a mostrare come introdurre osservabilità nel sistema.
